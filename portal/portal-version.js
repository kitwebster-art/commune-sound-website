(() => {
  const VERSION = 'portal-study-2.10.0';
  ...
  const installPortal = () => {
    ...
    canvas.dataset.visualContract = 'daily-three-background-rotation|distributed-black-negative-space|no-central-void|seven-transparent-wordmark-visit-rotation|pointer-responsive-depth|full-page-continuous-motion|mobile-composed';
